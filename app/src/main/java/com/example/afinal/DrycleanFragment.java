 ...
 */
public class DrycleanFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_dryclean, container, false);
    }
    @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.next_btn:
                int dryclean_quantity = numberPicker.getValue();
                callDeliveryScreen(dryclean_quantity);
                break;
            default:
                break;
        }
    }
    public void callDeliveryScreen(int dryclean_quantity) {
